...
import { PathNameContextProps, ToggleProps } from "src/types/defaults";
...
export const ToggleContext = createContext<ToggleProps>(null);

export const PathNameContext = createContext<PathNameContextProps>(null);
